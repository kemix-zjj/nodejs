...
const db = mysql.createPool({
    host:'127.0.0.1', //数据库的ip地址。本机是127.0.0.1
    user:'root', //登录数据库的账号
...
// // 演示如何更新用户的信息
// const user = { id:2,username:'hhhh',password:'9999'};
// // 定义SQL语句
...
// // 演示更新数据的便捷方式
// const user = { id: 6, username: 'aaaa', password: '000999'};
// // 定义SQL语句
...
// 注意：如果SQL语句中有多个占位符，则必须使用数字为每一个占位符指定具体的值
    //   如果SQL语句中只有一个占位符，则可以省略数字
